...
df_training <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training.csv"), header = TRUE)
df_validating <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/validating_test2.csv"), header = TRUE)


df_training_sinDesc_N2 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N2.csv"), header = TRUE)
df_validating_sinDesc_N2 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/validating_sinDesc_N2.csv"), header = TRUE)
df_training_sinDesc_N3 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N3.csv"), header = TRUE)
df_validating_sinDesc_N3 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/validating_sinDesc_N3.csv"), header = TRUE)
df_training_sinDesc_N4 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N4.csv"), header = TRUE)
df_validating_sinDesc_N4 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/validating_sinDesc_N4.csv"), header = TRUE)
df_training_sinDesc_N5 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N5.csv"), header = TRUE)
df_validating_sinDesc_N5 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/validating_sinDesc_N5.csv"), header = TRUE)
df_training_sinDesc_N6 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N6.csv"), header = TRUE)
df_validating_sinDesc_N6 <- h2o.importFile(path = normalizePath("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/validating_sinDesc_N6.csv"), header = TRUE)
...
#h2o.saveModel(rf_nivel1_v1, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/random_forest")
h2o.saveModel(rf_nivel1_v1, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")
...
rf_n2_m1 <- h2o.randomForest(
  ...
  seed = 1234)
#summary(rf_n2_m1)
#h2o.saveModel(rf_n2_m1, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/random_forest")
h2o.saveModel(rf_n2_m1, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")

#modelo 2: diferenciación de tipos incluyendo desconocidos e independiente a niveles anteriores
#rf_n2_m2 <- h2o.randomForest(
#  model_id="rf_n2_m2", 
#  training_frame=train, 
...
rf_n2_m4 <- h2o.randomForest(
  ...
  seed = 1234)
#summary(rf_n2_m4)
h2o.saveModel(rf_n2_m4, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")
...
rf_n3_m1 <- h2o.randomForest(
  ...
  seed = 1234)
#summary(rf_n3_m1)
h2o.saveModel(rf_n3_m1, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")

#modelo 2: diferenciación de tipos incluyendo desconocidos e independiente a niveles anteriores
#rf_n3_m2 <- h2o.randomForest(
#  model_id="rf_n3_m2", 
#  training_frame=train, 
...
rf_n3_m4 <- h2o.randomForest(
  ...
  seed = 1234)
#summary(rf_n3_m4)
h2o.saveModel(rf_n3_m4, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")
...
rf_n4_m1 <- h2o.randomForest(
  ...
  seed = 1234)
#summary(rf_n4_m1)
h2o.saveModel(rf_n4_m1, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")

#modelo 2: diferenciación de tipos incluyendo desconocidos e independiente a niveles anteriores
#rf_n4_m2 <- h2o.randomForest(
#  model_id="rf_n4_m2", 
#  training_frame=train, 
...
rf_n4_m4 <- h2o.randomForest(
  ...
  seed = 1234)
#summary(rf_n4_m4)
h2o.saveModel(rf_n4_m4, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")
...
rf_n5_m1 <- h2o.randomForest(
  ...
  seed = 1234)
#summary(rf_n5_m1)
h2o.saveModel(rf_n5_m1, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")

#modelo 2: diferenciación de tipos incluyendo desconocidos e independiente a niveles anteriores
#rf_n5_m2 <- h2o.randomForest(
#  model_id="rf_n5_m2", 
#  training_frame=train, 
...
rf_n5_m4 <- h2o.randomForest(
  ...
  seed = 1234)
#summary(rf_n5_m4)
h2o.saveModel(rf_n5_m4, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/soloTest2")
