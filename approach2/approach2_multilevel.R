...
#H2O call models have their own internal metrics on output model, that's why can be attached validating data frames, this case we have not same situation, it is enought with training frames

#./data/approaches2and3/.....
...
#training.csv
#validating_test1.csv
#validating_test10.csv
#validating_test25.csv

#training_knownResources_L2.csv
#training_knownResources_L3.csv
#training_knownResources_L4.csv
#training_knownResources_L5.csv
#validating_knownResources_L2.csv
#validating_knownResources_L3.csv
#validating_knownResources_L4.csv
#validating_knownResources_L5.csv
...
df_training_sinDesc_N2 <- read.csv(file="./data/approaches2and3/test1/training_knownResources_L2.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N3 <- read.csv(file="./data/approaches2and3/test1/training_knownResources_L3.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N4 <- read.csv(file="./data/approaches2and3/test1/training_knownResources_L4.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N5 <- read.csv(file="./data/approaches2and3/test1/training_knownResources_L5.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
save.image("./output/models/approach2/test1_C50.RData")
...
#para test
test_n1 <- predict(object = c50_nivel1_v3, newdata = df_validating[,2:(ncol(df_validating)-11)])
test_n2_m1 <- predict(object = c50_n2_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test_n2_m3 <- predict(object = c50_n2_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test_n3_m1 <- predict(object = c50_n3_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test_n3_m3 <- predict(object = c50_n3_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test_n4_m1 <- predict(object = c50_n4_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test_n4_m3 <- predict(object = c50_n4_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test_n5_m1 <- predict(object = c50_n5_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test_n5_m3 <- predict(object = c50_n5_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])

#paso tabla unida
test <- cbind(as.data.frame(df_validating[,1]),     #1
               test_n1,    #2
               test_n2_m1, #3
               test_n2_m3, #4
               test_n3_m1, #5
...
write.csv(test, file = "./output/models/approach2/test1_C50.csv", fileEncoding = "UTF-8", row.names=FALSE)
