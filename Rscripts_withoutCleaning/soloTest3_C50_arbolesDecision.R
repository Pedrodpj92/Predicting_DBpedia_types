...
df_training <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest3/training.csv",
...
df_validating <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest3/validating_test3.csv",
                        header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N2 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest3/training_sinDesc_N2.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N3 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest3/training_sinDesc_N3.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N4 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest3/training_sinDesc_N4.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N5 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest3/training_sinDesc_N5.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
#para Test3
test3_n1 <- predict(object = c50_nivel1_v3, newdata = df_validating[,2:(ncol(df_validating)-11)])
test3_n2_m1 <- predict(object = c50_n2_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test3_n2_m3 <- predict(object = c50_n2_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
#test3_n2_m4 <- predict(object = c50_n2_m4, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-10))])
test3_n3_m1 <- predict(object = c50_n3_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test3_n3_m3 <- predict(object = c50_n3_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
#test3_n3_m4 <- predict(object = c50_n3_m4, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-8))])
test3_n4_m1 <- predict(object = c50_n4_m1, newdata = df_validating[,c(2:(ncol(df_validating)-6))])
test3_n4_m3 <- predict(object = c50_n4_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
...
test3_n5_m1 <- predict(object = c50_n5_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test3_n5_m3 <- predict(object = c50_n5_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
...
test3 <- cbind(as.data.frame(df_validating[,1]),
               test3_n1,    #2
               test3_n2_m1, #3
               test3_n2_m3, #4
               test3_n3_m1, #5
...
write.csv(test3, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/soloTest3/test3_modoTabla_c50_cv.csv", fileEncoding = "UTF-8", row.names=FALSE)
...
write.csv(salida_test3, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/soloTest3/test3_v1_C50.ttl", fileEncoding = "UTF-8", row.names=FALSE)
