...
df_training_test1 <- h2o.importFile(path = normalizePath("./data/approach1/test1/training.csv"), header = TRUE)
df_validating_test1 <- h2o.importFile(path = normalizePath("./data/approach1/test1/validating_test1.csv"), header = TRUE)
...
nb_pruebaHojas_test1 <- h2o.naiveBayes(
  ...
  y=ncol(train_test1),
  seed = 1234)
h2o.saveModel(nb_pruebaHojas_test1, path="./output/models")
...
write.csv(salida_test1, file = "./output/data/approach1/test1/test1_nb.ttl", fileEncoding = "UTF-8", row.names=FALSE)
