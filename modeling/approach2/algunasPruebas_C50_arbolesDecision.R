...
df_training_sinDesc_N2 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/training_sinDesc_N2.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N3 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/training_sinDesc_N3.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N4 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/training_sinDesc_N4.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N5 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/training_sinDesc_N5.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_validating_test1 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/validating_test1.csv",
                          header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
colnames(df_validating_test1) <- df_validating_test1[1,]
df_validating_test1 <- df_validating_test1[-1,]
df_validating_test1[,c(2:(ncol(df_validating_test1)-11))] <- sapply(df_validating_test1[,c(2:(ncol(df_validating_test1)-11))], as.numeric)

df_validating_test2 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/validating_test2.csv",
                          header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
colnames(df_validating_test2) <- df_validating_test2[1,]
df_validating_test2 <- df_validating_test2[-1,]
df_validating_test2[,c(2:(ncol(df_validating_test2)-11))] <- sapply(df_validating_test2[,c(2:(ncol(df_validating_test2)-11))], as.numeric)

df_validating_test3 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/validating_test3.csv",
                          header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
colnames(df_validating_test3) <- df_validating_test3[1,]
df_validating_test3 <- df_validating_test3[-1,]
df_validating_test3[,c(2:(ncol(df_validating_test3)-11))] <- sapply(df_validating_test3[,c(2:(ncol(df_validating_test3)-11))], as.numeric)
...
#nivel 4
c50_n4_m1 <- C50::C5.0( df_training[,c(2:(ncol(df_training)-6))], df_training[,ncol(df_training)-4] )
...
save.image("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/c50_modeladoCompleto.RData")
...
#para Test1
test1_n1 <- predict(object = c50_nivel1_v3, newdata = df_validating_test1[,2:(ncol(df_validating_test1)-11)])
test1_n2_m1 <- predict(object = c50_n2_m1, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-11))])
test1_n2_m3 <- predict(object = c50_n2_m3, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-11))])
#test1_n2_m4 <- predict(object = c50_n2_m4, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-10))])
test1_n3_m1 <- predict(object = c50_n3_m1, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-11))])
test1_n3_m3 <- predict(object = c50_n3_m3, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-11))])
...
test1_n4_m1 <- predict(object = c50_n4_m1, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-6))])
test1_n4_m3 <- predict(object = c50_n4_m3, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-11))])
...
test1_n5_m1 <- predict(object = c50_n5_m1, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-11))])
test1_n5_m3 <- predict(object = c50_n5_m3, newdata = df_validating_test1[,c(2:(ncol(df_validating_test1)-11))])
...
#para Test2
test2_n1 <- predict(object = c50_nivel1_v3, newdata = df_validating_test2[,2:(ncol(df_validating_test2)-11)])
test2_n2_m1 <- predict(object = c50_n2_m1, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-11))])
test2_n2_m3 <- predict(object = c50_n2_m3, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-11))])
#test2_n2_m4 <- predict(object = c50_n2_m4, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-10))])
test2_n3_m1 <- predict(object = c50_n3_m1, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-11))])
test2_n3_m3 <- predict(object = c50_n3_m3, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-11))])
#test2_n3_m4 <- predict(object = c50_n3_m4, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-8))])
test2_n4_m1 <- predict(object = c50_n4_m1, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-6))])
test2_n4_m3 <- predict(object = c50_n4_m3, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-11))])
#test2_n4_m4 <- predict(object = c50_n4_m4, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-6))])
#test2_n4_m4 <- predict(object = c50_n4_m4, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-9),(ncol(df_validating_test2)-7))])
test2_n5_m1 <- predict(object = c50_n5_m1, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-11))])
test2_n5_m3 <- predict(object = c50_n4_m3, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-11))])
#test2_n5_m4 <- predict(object = c50_n5_m4, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-4))])
#test2_n5_m4 <- predict(object = c50_n5_m4, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-9),(ncol(df_validating_test2)-7),(ncol(df_validating_test2)-5))])

#para Test3
test3_n1 <- predict(object = c50_nivel1_v3, newdata = df_validating_test3[,2:(ncol(df_validating_test3)-11)])
test3_n2_m1 <- predict(object = c50_n2_m1, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-11))])
test3_n2_m3 <- predict(object = c50_n2_m3, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-11))])
#test3_n2_m4 <- predict(object = c50_n2_m4, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-10))])
test3_n3_m1 <- predict(object = c50_n3_m1, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-11))])
test3_n3_m3 <- predict(object = c50_n3_m3, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-11))])
#test3_n3_m4 <- predict(object = c50_n3_m4, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-8))])
test3_n4_m1 <- predict(object = c50_n4_m1, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-6))])
test3_n4_m3 <- predict(object = c50_n4_m3, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-11))])
#test3_n4_m4 <- predict(object = c50_n4_m4, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-6))])
#test3_n4_m4 <- predict(object = c50_n4_m4, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-9),(ncol(df_validating_test3)-7))])
test3_n5_m1 <- predict(object = c50_n5_m1, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-11))])
test3_n5_m3 <- predict(object = c50_n5_m3, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-11))])
#test3_n5_m4 <- predict(object = c50_n5_m4, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-4))])
#test3_n5_m4 <- predict(object = c50_n5_m4, newdata = df_validating_test3[,c(2:(ncol(df_validating_test3)-9),(ncol(df_validating_test3)-7),(ncol(df_validating_test3)-5))])
...
#paso tabla unida
test1 <- cbind(as.data.frame(df_validating_test1[,1]),     #1
               test1_n1,    #2
               test1_n2_m1, #3
               test1_n2_m3, #4
               test1_n3_m1, #5
...
test2 <- cbind(as.data.frame(df_validating_test2[,1]),
               test2_n1,    #2
               test2_n2_m1, #3
               test2_n2_m3, #4
               test2_n3_m1, #5
...
test3 <- cbind(as.data.frame(df_validating_test3[,1]),
               test3_n1,    #2
               test3_n2_m1, #3
               test3_n2_m3, #4
               test3_n3_m1, #5
...
write.csv(test1, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/test1_modoTabla_c50_cv.csv", fileEncoding = "UTF-8", row.names=FALSE)
write.csv(test2, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/test2_modoTabla_c50_cv.csv", fileEncoding = "UTF-8", row.names=FALSE)
write.csv(test3, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/test3_modoTabla_c50_cv.csv", fileEncoding = "UTF-8", row.names=FALSE)
...
write.csv(salida_test1, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/test1_v1_C50.ttl", fileEncoding = "UTF-8", row.names=FALSE)

salida_test2$p <- "<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>"
salida_test2[,c(1,2,3)] <- salida_test2[,c(1,3,2)]
write.csv(salida_test2, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/test2_v1_C50.ttl", fileEncoding = "UTF-8", row.names=FALSE)

salida_test3$p <- "<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>"
salida_test3[,c(1,2,3)] <- salida_test3[,c(1,3,2)]
write.csv(salida_test3, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/test3_v1_C50.ttl", fileEncoding = "UTF-8", row.names=FALSE)
