...
dl_nivel1_v2_cv <- h2o.deeplearning(
  model_id="dl_nivel1_v2_cv",#cambiar más adelante por dl_n1_m1
  training_frame=train, 
...
h2o.saveModel(dl_nivel1_v2_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")
...
dl_n2_m1_cv <- h2o.deeplearning(
  model_id="dl_n2_m1_cv", 
  training_frame=train, 
  ...
  seed = 1234)
#summary(dl_n2_m1)
h2o.saveModel(dl_n2_m1_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 2: diferenciación de tipos incluyendo desconocidos e independiente a niveles anteriores
dl_n2_m2_cv <- h2o.deeplearning(
  model_id="dl_n2_m2_cv", 
  training_frame=train, 
  ...
  seed = 1234)
#summary(dl_n2_m2)
h2o.saveModel(dl_n2_m2_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 3: difereniación de tipos entrenando sin desconocidos e independiente a niveles anteriores
dl_n2_m3_cv <- h2o.deeplearning(
  model_id="dl_n2_m3_cv", 
  ...
  seed = 1234)
#summary(dl_n2_m3)
h2o.saveModel(dl_n2_m3_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 4: diferenciación de tipos entrenando sin desconocidos y encadenando niveles anteriores
dl_n2_m4_cv <- h2o.deeplearning(
  model_id="dl_n2_m4_cv", 
  training_frame=train_sinDesc_N2, 
  ...
  seed = 1234)
#summary(dl_n2_m4)
h2o.saveModel(dl_n2_m4_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")


###Nivel 3

#modelo 1: diferenciación binaria sobre si debería o no tener asignado un tipo
dl_n3_m1_cv <- h2o.deeplearning(
  model_id="dl_n3_m1_cv", 
  training_frame=train, 
  ...
  seed = 1234)
#summary(dl_n3_m1)
h2o.saveModel(dl_n3_m1_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 2: diferenciación de tipos incluyendo desconocidos e independiente a niveles anteriores
dl_n3_m2_cv <- h2o.deeplearning(
  model_id="dl_n3_m2_cv", 
  training_frame=train, 
  ...
  seed = 1234)
#summary(dl_n3_m2)
h2o.saveModel(dl_n3_m2_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 3: difereniación de tipos entrenando sin desconocidos e independiente a niveles anteriores
dl_n3_m3_cv <- h2o.deeplearning(
  model_id="dl_n3_m3_cv", 
  ...
  seed = 1234)
#summary(dl_n3_m3)
h2o.saveModel(dl_n3_m3_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 4: diferenciación de tipos entrenando sin desconocidos y encadenando niveles anteriores
dl_n3_m4_cv <- h2o.deeplearning(
  model_id="dl_n3_m4_cv", 
  training_frame=train_sinDesc_N3, 
  ...
  seed = 1234)
#summary(dl_n3_m4)
h2o.saveModel(dl_n3_m4_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")
...
#modelo 1: diferenciación binaria sobre si debería o no tener asignado un tipo
dl_n4_m1_cv <- h2o.deeplearning(
  model_id="dl_n4_m1_cv", 
  training_frame=train, 
  ...
  seed = 1234)
#summary(dl_n4_m1)
h2o.saveModel(dl_n4_m1_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 2: diferenciación de tipos incluyendo desconocidos e independiente a niveles anteriores
dl_n4_m2_cv <- h2o.deeplearning(
  model_id="dl_n4_m2_cv", 
  training_frame=train, 
  ...
  seed = 1234)
#summary(dl_n4_m2)
h2o.saveModel(dl_n4_m2_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 3: difereniación de tipos entrenando sin desconocidos e independiente a niveles anteriores
dl_n4_m3_cv <- h2o.deeplearning(
  model_id="dl_n4_m3_cv", 
  ...
  seed = 1234)
#summary(dl_n4_m3)
h2o.saveModel(dl_n4_m3_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 4: diferenciación de tipos entrenando sin desconocidos y encadenando niveles anteriores
dl_n4_m4_cv <- h2o.deeplearning(
  model_id="dl_n4_m4_cv", 
  training_frame=train_sinDesc_N4, 
  ...
  seed = 1234)
#summary(dl_n4_m4)
h2o.saveModel(dl_n4_m4_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")
...
#modelo 1: diferenciación binaria sobre si debería o no tener asignado un tipo
dl_n5_m1_cv <- h2o.deeplearning(
  model_id="dl_n5_m1_cv", 
  training_frame=train, 
  ...
  seed = 1234)
#summary(dl_n5_m1)
h2o.saveModel(dl_n5_m1_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 2: diferenciación de tipos incluyendo desconocidos e independiente a niveles anteriores
dl_n5_m2_cv <- h2o.deeplearning(
  model_id="dl_n5_m2_cv", 
  training_frame=train, 
  ...
  seed = 1234)
#summary(dl_n5_m2)
h2o.saveModel(dl_n5_m2_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 3: difereniación de tipos entrenando sin desconocidos e independiente a niveles anteriores
dl_n5_m3_cv <- h2o.deeplearning(
  model_id="dl_n5_m3_cv", 
  ...
  seed = 1234)
#summary(dl_n5_m3)
h2o.saveModel(dl_n5_m3_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")

#modelo 4: diferenciación de tipos entrenando sin desconocidos y encadenando niveles anteriores
dl_n5_m4_cv <- h2o.deeplearning(
  model_id="dl_n5_m4_cv", 
  training_frame=train_sinDesc_N5, 
  #validation_frame=valid_sinDesc_N4[,c(2:(ncol(valid_sinDesc_N4)-9),(ncol(valid_sinDesc_N4)-7),(ncol(valid_sinDesc_N4)-5))],
  ...
  seed = 1234)
#summary(dl_n5_m4)
h2o.saveModel(dl_n5_m4_cv, path="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/models/crossValidation")
