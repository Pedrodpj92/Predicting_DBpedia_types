...
write.csv(conversion_Matriz, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/objects_properties_Matrix.csv", fileEncoding = "UTF-8", row.names=FALSE)
...
write.csv(datosObjetivo, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/learingSet.csv", fileEncoding = "UTF-8", row.names=FALSE)
...
write.csv(countingIngoing, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/countingIngoings.csv", fileEncoding = "UTF-8", row.names=FALSE)
