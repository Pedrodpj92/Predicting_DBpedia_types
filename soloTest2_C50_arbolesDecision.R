...
df_training <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training.csv",
...
df_validating <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/validating_test2.csv",
                        header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N2 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N2.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N3 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N3.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N4 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N4.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
df_training_sinDesc_N5 <- read.csv(file="/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/inputData/divisionSDtypes/soloTest2/training_sinDesc_N5.csv",
                                   header=FALSE, sep=",", encoding = "UTF-8", stringsAsFactors = FALSE)
...
save.image("/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/c50_modeladoCompleto_soloTest2.RData")
...
#para Test2
test2_n1 <- predict(object = c50_nivel1_v3, newdata = df_validating[,2:(ncol(df_validating)-11)])
test2_n2_m1 <- predict(object = c50_n2_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test2_n2_m3 <- predict(object = c50_n2_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
#test2_n2_m4 <- predict(object = c50_n2_m4, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-10))])
test2_n3_m1 <- predict(object = c50_n3_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test2_n3_m3 <- predict(object = c50_n3_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
#test2_n3_m4 <- predict(object = c50_n3_m4, newdata = df_validating_test2[,c(2:(ncol(df_validating_test2)-8))])
test2_n4_m1 <- predict(object = c50_n4_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test2_n4_m3 <- predict(object = c50_n4_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
...
test2_n5_m1 <- predict(object = c50_n5_m1, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
test2_n5_m3 <- predict(object = c50_n5_m3, newdata = df_validating[,c(2:(ncol(df_validating)-11))])
...
#paso tabla unida
test2 <- cbind(as.data.frame(df_validating[,1]),
               test2_n1,    #2
               test2_n2_m1, #3
               test2_n2_m3, #4
               test2_n3_m1, #5
...
write.csv(test2, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/soloTest2/test2_modoTabla_c50_cv.csv", fileEncoding = "UTF-8", row.names=FALSE)
...
write.csv(salida_test2, file = "/opt/files/proyectoHeiko_adaptado/R_proyectos/amelioratingTypes_ESWC2018/outputData/soloTest2/test2_v1_C50.ttl", fileEncoding = "UTF-8", row.names=FALSE)
